...
//   const workItems = [
//     { label: "Production House", path: "/work/production-house" },
//     { label: "Web Development", path: "/work/web-development" },
...
//   return (
//     <nav
//       className={`top-0 left-0 w-full flex justify-between items-center px-6 py-4 z-50 transition-colors duration-300 ${
...
//         <div className="space-y-1.5 relative w-6 h-6">
//           <span
//             className={`block w-6 h-0.5 bg-gray-700 absolute transition-all duration-300 ${
...
//             {/* Menu */}
//             <motion.div
//               className="fixed top-0 right-0 w-[70%] sm:w-[60%] md:w-[26%] h-full bg-white/70 backdrop-blur-xl z-50 p-8 flex flex-col"
//               variants={sidebarVariants}
//               initial="hidden"
//               animate="visible"
//               exit="exit"
